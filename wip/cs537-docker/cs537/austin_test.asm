...
int main(void)
{
  ...
  1f:	e8 8f 03 00 00       	call   3b3 <wmap>
  ...
  24:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  2b:	e8 93 03 00 00       	call   3c3 <va2pa>
  30:	83 c4 0c             	add    $0xc,%esp
  33:	50                   	push   %eax
  34:	68 00 10 00 00       	push   $0x1000
  39:	6a 01                	push   $0x1
  3b:	e8 40 04 00 00       	call   480 <printf>
	int rc = wunmap(0x60000000);
  40:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  47:	e8 6f 03 00 00       	call   3bb <wunmap>
  ...
  58:	51                   	push   %ecx
  59:	51                   	push   %ecx
  5a:	68 24 10 00 00       	push   $0x1024
  5f:	6a 01                	push   $0x1
  61:	e8 1a 04 00 00       	call   480 <printf>
	printf(1,"%d",va2pa(0x60000000));
  66:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  6d:	e8 51 03 00 00       	call   3c3 <va2pa>
  72:	83 c4 0c             	add    $0xc,%esp
  75:	50                   	push   %eax
  76:	68 5f 10 00 00       	push   $0x105f
  7b:	6a 01                	push   $0x1
  7d:	e8 fe 03 00 00       	call   480 <printf>
	if(va2pa(0x60000000) == -1) printf(1,"success!\n");
  82:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  89:	e8 35 03 00 00       	call   3c3 <va2pa>
  8e:	83 c4 10             	add    $0x10,%esp
  91:	83 c0 01             	add    $0x1,%eax
  94:	74 13                	je     a9 <main+0xa9>
	else printf(1,"FAIL\n");
  96:	50                   	push   %eax
  97:	50                   	push   %eax
  98:	68 6c 10 00 00       	push   $0x106c
  9d:	6a 01                	push   $0x1
  9f:	e8 dc 03 00 00       	call   480 <printf>
  a4:	83 c4 10             	add    $0x10,%esp
  a7:	eb aa                	jmp    53 <main+0x53>
	if(va2pa(0x60000000) == -1) printf(1,"success!\n");
  a9:	52                   	push   %edx
  aa:	52                   	push   %edx
  ab:	68 62 10 00 00       	push   $0x1062
  b0:	6a 01                	push   $0x1
  b2:	e8 c9 03 00 00       	call   480 <printf>
  b7:	83 c4 10             	add    $0x10,%esp
  ba:	eb 97                	jmp    53 <main+0x53>
  bc:	66 90                	xchg   %ax,%ax
  be:	66 90                	xchg   %ax,%ax
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 d4 10 00 00 	movzbl 0x10d4(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c5:	57                   	push   %edi
 4c6:	56                   	push   %esi
 4c7:	e8 67 fe ff ff       	call   333 <write>
 ...
 4f9:	ff 24 85 7c 10 00 00 	jmp    *0x107c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 51e:	e8 10 fe ff ff       	call   333 <write>
        putc(fd, c);
 ...
 5dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5df:	e8 4f fd ff ff       	call   333 <write>
        ap++;
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 72 10 00 00       	mov    $0x1072,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 00 30 00 00       	mov    0x3000,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 00 30 00 00    	mov    %edx,0x3000
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 00 30 00 00    	mov    %edx,0x3000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 00 30 00 00    	mov    0x3000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 00 30 00 00    	mov    0x3000,%edi
 ...
 713:	e8 83 fc ff ff       	call   39b <sbrk>
  if(p == (char*)-1)
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 00 30 00 00    	mov    0x3000,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 00 30 00 00    	mov    %edx,0x3000
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 00 30 00 00 04 	movl   $0x3004,0x3000
 777:	30 00 00 
    base.s.size = 0;
 77a:	bf 04 30 00 00       	mov    $0x3004,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 04 30 00 00 04 	movl   $0x3004,0x3004
 786:	30 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 08 30 00 00 00 	movl   $0x0,0x3008
 792:	00 00 00 
    if(p->s.size >= nunits){
