...
int main(void)
{
  ...
  1f:	e8 2f 03 00 00       	call   353 <wmap>
  ...
  27:	50                   	push   %eax
  28:	68 48 07 00 00       	push   $0x748
  2d:	6a 01                	push   $0x1
  2f:	e8 ec 03 00 00       	call   420 <printf>
	int rc = wunmap(0x60000000);
  34:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  3b:	e8 1b 03 00 00       	call   35b <wunmap>
	printf(1,"%d",rc);
  40:	83 c4 0c             	add    $0xc,%esp
  43:	50                   	push   %eax
  44:	68 59 07 00 00       	push   $0x759
  49:	6a 01                	push   $0x1
  4b:	e8 d0 03 00 00       	call   420 <printf>
