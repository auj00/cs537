...
int main(void) 
{
   ...
   d:	57                   	push   %edi
   e:	56                   	push   %esi
   f:	8d b5 68 ff ff ff    	lea    -0x98(%ebp),%esi
  15:	53                   	push   %ebx
  16:	51                   	push   %ecx
  17:	81 ec e4 00 00 00    	sub    $0xe4,%esp

  struct wmapinfo wminfo;
  // printf(1, "The process ID is: %d\n", test());

  printf(1, "The physical address is: %x\n", va2pa(0x60000123));
  1d:	68 23 01 00 60       	push   $0x60000123
  22:	e8 7c 04 00 00       	call   4a3 <va2pa>
  ...
  37:	6a ff                	push   $0xffffffff
  39:	6a 0e                	push   $0xe
  3b:	68 00 20 00 00       	push   $0x2000
  40:	68 00 00 00 60       	push   $0x60000000
  45:	e8 49 04 00 00       	call   493 <wmap>
  printf(1, "The address returned by wmap: %x\n", address);
  4a:	83 c4 1c             	add    $0x1c,%esp
  4d:	50                   	push   %eax
  4e:	68 04 09 00 00       	push   $0x904
  53:	6a 01                	push   $0x1
  55:	e8 16 05 00 00       	call   570 <printf>


  printf(1, "The return value of getwmapinfo: %d\n", getwmapinfo(&wminfo));
  5a:	8d 85 24 ff ff ff    	lea    -0xdc(%ebp),%eax
  60:	89 04 24             	mov    %eax,(%esp)
  63:	e8 43 04 00 00       	call   4ab <getwmapinfo>
  68:	83 c4 0c             	add    $0xc,%esp
  6b:	50                   	push   %eax
  6c:	68 28 09 00 00       	push   $0x928
  71:	6a 01                	push   $0x1
  73:	e8 f8 04 00 00       	call   570 <printf>
  printf(1, "total wmaps = %d\n", wminfo.total_mmaps);
  78:	83 c4 0c             	add    $0xc,%esp
  7b:	ff b5 24 ff ff ff    	push   -0xdc(%ebp)
  ...
  8d:	59                   	pop    %ecx
  8e:	5b                   	pop    %ebx
  8f:	68 c7 08 00 00       	push   $0x8c7
  94:	6a 01                	push   $0x1
  96:	8d 9d 28 ff ff ff    	lea    -0xd8(%ebp),%ebx
  9c:	89 df                	mov    %ebx,%edi
  9e:	e8 cd 04 00 00       	call   570 <printf>
  for(int i=0; i<16; i++)
  ...
  b3:	ff b7 80 00 00 00    	push   0x80(%edi)
  for(int i=0; i<16; i++)
  b9:	83 c7 04             	add    $0x4,%edi
    printf(1, "%x %d %d\n", wminfo.addr[i], wminfo.length[i], wminfo.n_loaded_pages[i]);
  bc:	ff 77 3c             	push   0x3c(%edi)
  bf:	ff 77 fc             	push   -0x4(%edi)
  c2:	68 dd 08 00 00       	push   $0x8dd
  c7:	6a 01                	push   $0x1
  c9:	e8 a2 04 00 00       	call   570 <printf>
  for(int i=0; i<16; i++)
  ce:	83 c4 20             	add    $0x20,%esp
  d1:	39 f7                	cmp    %esi,%edi
  ...
  d8:	68 23 01 00 60       	push   $0x60000123
  dd:	e8 c1 03 00 00       	call   4a3 <va2pa>
  e2:	83 c4 0c             	add    $0xc,%esp
  e5:	50                   	push   %eax
  e6:	68 98 08 00 00       	push   $0x898
  eb:	6a 01                	push   $0x1
  ...
  f2:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
  f9:	e8 9d 03 00 00       	call   49b <wunmap>
  fe:	83 c4 0c             	add    $0xc,%esp
 101:	50                   	push   %eax
 102:	68 e7 08 00 00       	push   $0x8e7
 107:	6a 01                	push   $0x1
 109:	e8 62 04 00 00       	call   570 <printf>
  
  
  printf(1, "The return value of getwmapinfo: %d\n", getwmapinfo(&wminfo));
 10e:	8d 85 24 ff ff ff    	lea    -0xdc(%ebp),%eax
 114:	89 04 24             	mov    %eax,(%esp)
 117:	e8 8f 03 00 00       	call   4ab <getwmapinfo>
 11c:	83 c4 0c             	add    $0xc,%esp
 11f:	50                   	push   %eax
 120:	68 28 09 00 00       	push   $0x928
 125:	6a 01                	push   $0x1
 127:	e8 44 04 00 00       	call   570 <printf>
  printf(1, "total wmaps = %d\n", wminfo.total_mmaps);
 12c:	83 c4 0c             	add    $0xc,%esp
 12f:	ff b5 24 ff ff ff    	push   -0xdc(%ebp)
 135:	68 b5 08 00 00       	push   $0x8b5
 13a:	6a 01                	push   $0x1
 13c:	e8 2f 04 00 00       	call   570 <printf>
  printf(1, "address length pages\n");
 141:	58                   	pop    %eax
 142:	5a                   	pop    %edx
 143:	68 c7 08 00 00       	push   $0x8c7
 148:	6a 01                	push   $0x1
 14a:	e8 21 04 00 00       	call   570 <printf>
 ...
 15b:	ff b3 80 00 00 00    	push   0x80(%ebx)
  for(int i=0; i<16; i++)
 161:	83 c3 04             	add    $0x4,%ebx
    printf(1, "%x %d %d\n", wminfo.addr[i], wminfo.length[i], wminfo.n_loaded_pages[i]);
 164:	ff 73 3c             	push   0x3c(%ebx)
 167:	ff 73 fc             	push   -0x4(%ebx)
 16a:	68 dd 08 00 00       	push   $0x8dd
 16f:	6a 01                	push   $0x1
 171:	e8 fa 03 00 00       	call   570 <printf>
  for(int i=0; i<16; i++)
 176:	83 c4 20             	add    $0x20,%esp
 179:	39 f3                	cmp    %esi,%ebx
 17b:	75 db                	jne    158 <main+0x158>
  }

  printf(1, "The physical address is: %x\n", va2pa(0x60000123));
 17d:	83 ec 0c             	sub    $0xc,%esp
 180:	68 23 01 00 60       	push   $0x60000123
 185:	e8 19 03 00 00       	call   4a3 <va2pa>
 18a:	83 c4 0c             	add    $0xc,%esp
 18d:	50                   	push   %eax
 18e:	68 98 08 00 00       	push   $0x898
 193:	6a 01                	push   $0x1
 195:	e8 d6 03 00 00       	call   570 <printf>
  exit();
 19a:	e8 54 02 00 00       	call   3f3 <exit>
 19f:	90                   	nop
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 ac 09 00 00 	movzbl 0x9ac(%edx),%edx
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b5:	57                   	push   %edi
 5b6:	56                   	push   %esi
 5b7:	e8 57 fe ff ff       	call   413 <write>
 ...
 5e9:	ff 24 85 54 09 00 00 	jmp    *0x954(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 60e:	e8 00 fe ff ff       	call   413 <write>
        putc(fd, c);
 ...
 61f:	57                   	push   %edi
 620:	56                   	push   %esi
 621:	e8 ed fd ff ff       	call   413 <write>
        putc(fd, c);
 ...
 6cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6cf:	e8 3f fd ff ff       	call   413 <write>
        ap++;
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba 4d 09 00 00       	mov    $0x94d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 64 0c 00 00       	mov    0xc64,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 64 0c 00 00    	mov    %edx,0xc64
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 64 0c 00 00    	mov    %edx,0xc64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d 64 0c 00 00    	mov    0xc64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d 64 0c 00 00    	mov    0xc64,%edi
 ...
 803:	e8 73 fc ff ff       	call   47b <sbrk>
  if(p == (char*)-1)
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 64 0c 00 00    	mov    0xc64,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 64 0c 00 00    	mov    %edx,0xc64
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 64 0c 00 00 68 	movl   $0xc68,0xc64
 867:	0c 00 00 
    base.s.size = 0;
 86a:	bf 68 0c 00 00       	mov    $0xc68,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 68 0c 00 00 68 	movl   $0xc68,0xc68
 876:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 6c 0c 00 00 00 	movl   $0x0,0xc6c
 882:	00 00 00 
    if(p->s.size >= nunits){
