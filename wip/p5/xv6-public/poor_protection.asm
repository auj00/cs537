...
_poor_protection:     file format elf32-i386
...
str[1] = 'O';
  11:	a1 00 30 00 00       	mov    0x3000,%eax
  16:	c6 40 01 4f          	movb   $0x4f,0x1(%eax)
printf(1,"%s\n", str);
  1a:	ff 35 00 30 00 00    	push   0x3000
  20:	68 00 10 00 00       	push   $0x1000
  25:	6a 01                	push   $0x1
  27:	e8 e4 03 00 00       	call   410 <printf>
exit();
  2c:	e8 62 02 00 00       	call   293 <exit>
  31:	66 90                	xchg   %ax,%ax
  33:	66 90                	xchg   %ax,%ax
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 84 10 00 00 	movzbl 0x1084(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 2c 10 00 00 	jmp    *0x102c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 22 10 00 00       	mov    $0x1022,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 04 30 00 00       	mov    0x3004,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 04 30 00 00    	mov    %edx,0x3004
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 04 30 00 00    	mov    %edx,0x3004
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 04 30 00 00    	mov    0x3004,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 04 30 00 00    	mov    0x3004,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 04 30 00 00    	mov    0x3004,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 04 30 00 00    	mov    %edx,0x3004
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 04 30 00 00 08 	movl   $0x3008,0x3004
 707:	30 00 00 
    base.s.size = 0;
 70a:	bf 08 30 00 00       	mov    $0x3008,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 08 30 00 00 08 	movl   $0x3008,0x3008
 716:	30 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 0c 30 00 00 00 	movl   $0x0,0x300c
 722:	00 00 00 
    if(p->s.size >= nunits){
