...
_austin_test:     file format elf32-i386
...
int main(void)
{
  ...
  13:	6a ff                	push   $0xffffffff
  15:	6a 0e                	push   $0xe
  17:	68 a8 0f 00 00       	push   $0xfa8
  1c:	68 00 20 00 60       	push   $0x60002000
  21:	e8 0d 04 00 00       	call   433 <wmap>
  ...
  26:	c7 04 24 00 20 00 60 	movl   $0x60002000,(%esp)
  2d:	e8 11 04 00 00       	call   443 <va2pa>
  32:	83 c4 0c             	add    $0xc,%esp
  35:	50                   	push   %eax
  36:	68 00 10 00 00       	push   $0x1000
  3b:	6a 01                	push   $0x1
  3d:	e8 ce 04 00 00       	call   510 <printf>
	struct wmapinfo *ptr = malloc(sizeof(struct wmapinfo));
  42:	c7 04 24 c4 00 00 00 	movl   $0xc4,(%esp)
  49:	e8 f2 06 00 00       	call   740 <malloc>
if (ptr == 0) {
  4e:	83 c4 10             	add    $0x10,%esp
  51:	85 c0                	test   %eax,%eax
  53:	75 1f                	jne    74 <main+0x74>
    // Handle memory allocation failure
    printf(1,"malloc failed");
  55:	83 ec 08             	sub    $0x8,%esp
  58:	68 5f 10 00 00       	push   $0x105f
  5d:	6a 01                	push   $0x1
  5f:	e8 ac 04 00 00       	call   510 <printf>
	int ret = va2pa(0x0);
    if (ret == FAILED) {
        printf(1,"va2pa(0x%x)` failed\n", 0);
    }
	exit();
  64:	8d 65 f4             	lea    -0xc(%ebp),%esp
  67:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  6c:	59                   	pop    %ecx
  6d:	5b                   	pop    %ebx
  6e:	5e                   	pop    %esi
  6f:	5d                   	pop    %ebp
  70:	8d 61 fc             	lea    -0x4(%ecx),%esp
  73:	c3                   	ret    
int rc2 = getwmapinfo(ptr);
  74:	83 ec 0c             	sub    $0xc,%esp
  77:	89 c3                	mov    %eax,%ebx
  79:	50                   	push   %eax
  7a:	e8 cc 03 00 00       	call   44b <getwmapinfo>
	if(rc2!=0) printf(1,"error\n");
  7f:	83 c4 10             	add    $0x10,%esp
  82:	85 c0                	test   %eax,%eax
  84:	75 35                	jne    bb <main+0xbb>
{
  86:	31 f6                	xor    %esi,%esi
  88:	eb 08                	jmp    92 <main+0x92>
		for(int i=0; i<16; i++)
  8a:	83 c6 01             	add    $0x1,%esi
  8d:	83 fe 10             	cmp    $0x10,%esi
  90:	74 3c                	je     ce <main+0xce>
    if(ptr->n_loaded_pages[i] != 0)
  92:	8b 84 b3 84 00 00 00 	mov    0x84(%ebx,%esi,4),%eax
  99:	85 c0                	test   %eax,%eax
  9b:	74 ed                	je     8a <main+0x8a>
		printf(1,"%d %d %d %d\n",ptr->addr[i],ptr->length[i],ptr->n_loaded_pages[i],ptr->total_mmaps);
  9d:	51                   	push   %ecx
  9e:	51                   	push   %ecx
  9f:	ff 33                	push   (%ebx)
  a1:	50                   	push   %eax
  a2:	ff 74 b3 44          	push   0x44(%ebx,%esi,4)
  a6:	ff 74 b3 04          	push   0x4(%ebx,%esi,4)
  aa:	68 74 10 00 00       	push   $0x1074
  af:	6a 01                	push   $0x1
  b1:	e8 5a 04 00 00       	call   510 <printf>
  b6:	83 c4 20             	add    $0x20,%esp
  b9:	eb cf                	jmp    8a <main+0x8a>
	if(rc2!=0) printf(1,"error\n");
  bb:	56                   	push   %esi
  bc:	56                   	push   %esi
  bd:	68 6d 10 00 00       	push   $0x106d
  c2:	6a 01                	push   $0x1
  c4:	e8 47 04 00 00       	call   510 <printf>
  c9:	83 c4 10             	add    $0x10,%esp
  cc:	eb b8                	jmp    86 <main+0x86>
	int rc = wunmap(0x60000000);
  ce:	83 ec 0c             	sub    $0xc,%esp
  d1:	68 00 00 00 60       	push   $0x60000000
  d6:	e8 60 03 00 00       	call   43b <wunmap>
  ...
  e5:	6a 00                	push   $0x0
  e7:	e8 57 03 00 00       	call   443 <va2pa>
    if (ret == FAILED) {
  ec:	83 c4 10             	add    $0x10,%esp
  ef:	83 c0 01             	add    $0x1,%eax
  f2:	74 34                	je     128 <main+0x128>
	exit();
  f4:	e8 9a 02 00 00       	call   393 <exit>
	if (rc == 0) {printf(1,"FREED! checking if physical page removed from pgtable....\n");
  f9:	52                   	push   %edx
  fa:	52                   	push   %edx
  fb:	68 24 10 00 00       	push   $0x1024
 100:	6a 01                	push   $0x1
 102:	e8 09 04 00 00       	call   510 <printf>
	printf(1,"%d",va2pa(0x60000000));
 107:	c7 04 24 00 00 00 60 	movl   $0x60000000,(%esp)
 10e:	e8 30 03 00 00       	call   443 <va2pa>
 113:	83 c4 0c             	add    $0xc,%esp
 116:	50                   	push   %eax
 117:	68 81 10 00 00       	push   $0x1081
 11c:	6a 01                	push   $0x1
 11e:	e8 ed 03 00 00       	call   510 <printf>
 123:	83 c4 10             	add    $0x10,%esp
 126:	eb ba                	jmp    e2 <main+0xe2>
        printf(1,"va2pa(0x%x)` failed\n", 0);
 128:	50                   	push   %eax
 129:	6a 00                	push   $0x0
 12b:	68 84 10 00 00       	push   $0x1084
 130:	6a 01                	push   $0x1
 132:	e8 d9 03 00 00       	call   510 <printf>
 137:	83 c4 10             	add    $0x10,%esp
 13a:	eb b8                	jmp    f4 <main+0xf4>
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 f8 10 00 00 	movzbl 0x10f8(%edx),%edx
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 a0 10 00 00 	jmp    *0x10a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 99 10 00 00       	mov    $0x1099,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 00 30 00 00       	mov    0x3000,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 00 30 00 00    	mov    %edx,0x3000
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 00 30 00 00    	mov    %edx,0x3000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 00 30 00 00    	mov    0x3000,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 00 30 00 00    	mov    0x3000,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 00 30 00 00    	mov    0x3000,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 00 30 00 00    	mov    %edx,0x3000
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 00 30 00 00 04 	movl   $0x3004,0x3000
 807:	30 00 00 
    base.s.size = 0;
 80a:	bf 04 30 00 00       	mov    $0x3004,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 04 30 00 00 04 	movl   $0x3004,0x3004
 816:	30 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 08 30 00 00 00 	movl   $0x0,0x3008
 822:	00 00 00 
    if(p->s.size >= nunits){
